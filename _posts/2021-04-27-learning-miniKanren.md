...
I've spent quite a bit of time in the last semester working with
[miniKanren](http://minikanren.org/) in an attempt to implement at least a
sizeable subset of it metacircularly. The result of these efforts is metaKanren,
which is
[microKanren](http://webyrd.net/scheme-2013/papers/HemannMuKanren2013.pdf)
extended to support user-defined relations. This post goes over what I feel are
the resources that helped me gain enough of an understanding to achieve this.
...
4. [$\mu$Kanren : A Minimal Functional Core for Relational
   ...
   lines of dense miniKanren code when I implemented metaKanren, so it is quite
...
One more paper I had to understand for implementing metaKanren, but isn't
...
All in all, metaKanren taught me a ton about implementing interpreters, relational
